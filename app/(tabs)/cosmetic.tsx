...
const THEMES: Theme[] = [
  { id:'nexus',   name:'NEXUS DARK',     sub:'Default · Cyan & Navy',    accent:'#00E5FF', bg:'#060D18', preview:['#060D18','#0A1520','#00E5FF','#00FF9D'] },
  { id:'quantum', name:'QUANTUM AMBER',  sub:'Warm glow · Gold & Black', accent:'#FFB020', bg:'#080500', preview:['#080500','#120A00','#FFB020','#FF6B2D'] },
  { id:'sigma',   name:'SIGMA PURPLE',   sub:'Neural · Violet & Deep',   accent:'#CC44FF', bg:'#08040F', preview:['#08040F','#100818','#CC44FF','#4A8DFF'] },
  { id:'matrix',  name:'MATRIX GREEN',   sub:'Terminal · Green on Black', accent:'#00FF9D', bg:'#020804', preview:['#020804','#050F08','#00FF9D','#00CCBB'] },
  { id:'steel',   name:'STEEL BLUE',     sub:'Industrial · Blue & Grey',  accent:'#4A8DFF', bg:'#04080F', preview:['#04080F','#080F18','#4A8DFF','#00E5FF'] },
  { id:'lava',    name:'LAVA RED',        sub:'Danger · Red & Obsidian',   accent:'#FF3D5A', bg:'#0A0202', preview:['#0A0202','#140404','#FF3D5A','#FFB020'] },
  { id:'teal',    name:'TEAL CYBER',     sub:'Clean · Teal & Midnight',   accent:'#00CCBB', bg:'#030A09', preview:['#030A09','#061210','#00CCBB','#00E5FF'] },
  { id:'phantom', name:'PHANTOM',        sub:'Stealth · White on Black',  accent:'#E0E8F0', bg:'#020202', preview:['#020202','#080808','#E0E8F0','#888EA0'] },
];
...
function CosmeticInner() {
  ...
  const ACCENT = THEMES.find(t => t.id===active)?.accent || '#00E5FF';
...
const SH = StyleSheet.create({
  root: { backgroundColor:'#06080E', overflow:'hidden' },

...
const LEVEL_COLOR: Record<LogLevel,string> = {
  SYS:'#4A8DFF', AI:'#CC44FF', NET:'#00FF9D', SEC:'#FFB020', ERR:'#FF3D5A', INFO:'#00E5FF'
};
...
const LogHeader = memo(({ safeTop, isConn, total }: { safeTop:number; isConn:boolean; total:number }) => {
  ...
  return (
    <View style={[LH.root, { paddingTop:safeTop }]}>
...
const LH = StyleSheet.create({
  root: { backgroundColor:'#040810', overflow:'hidden' },
...
function LogsInner() {
  ...
  return (
    <View style={{ flex:1, backgroundColor:BG }}>
      ...
      {/* Terminal header */}
      <View style={{ flexDirection:'row', alignItems:'center', gap:5, paddingHorizontal:12, paddingVertical:7, backgroundColor:'#020508', borderBottomWidth:1, borderBottomColor: DIM+'80' }}>
